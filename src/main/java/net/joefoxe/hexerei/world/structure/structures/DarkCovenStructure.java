...
public class DarkCovenStructure extends StructureFeature<JigsawConfiguration> {
    ...
    public DarkCovenStructure() {
        ...
        super(JigsawConfiguration.CODEC, DarkCovenStructure::createPiecesGenerator, PostPlacementProcessor.NONE);
    }
    ...
    private static boolean isFeatureChunk(PieceGeneratorSupplier.Context<JigsawConfiguration> context) {
        ...
        ResourceKey<StructureSet> key = ResourceKey.<StructureSet>create(Registry.STRUCTURE_SET_REGISTRY, new ResourceLocation(Hexerei.MOD_ID, "witch_hut"));
        return !context.chunkGenerator().hasFeatureChunkInRange(key, context.seed(), chunkpos.x, chunkpos.z, 1);
    }
    ...
    public static Optional<PieceGenerator<JigsawConfiguration>> createPiecesGenerator(PieceGeneratorSupplier.Context<JigsawConfiguration> context) {
        ...
        if (!DarkCovenStructure.isFeatureChunk(context)) {
            return Optional.empty();
        }
        ...
        int topLandY = context.chunkGenerator().getFirstFreeHeight(blockpos.getX(), blockpos.getZ(), Heightmap.Types.WORLD_SURFACE_WG, context.heightAccessor()) + 5;
        ...
        if(structurePiecesGenerator.isPresent()) {
            ...
            Hexerei.LOGGER.log(Level.DEBUG, "DarkCoven at {}", blockpos);
        }
