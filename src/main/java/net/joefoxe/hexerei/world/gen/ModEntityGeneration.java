    ...
    public static void onEntitySpawn(final BiomeLoadingEvent event) {
        ...
        if (BiomeDictionary.hasType(key, BiomeDictionary.Type.OVERWORLD) && BiomeDictionary.hasType(key, BiomeDictionary.Type.FOREST)) {
            event.getSpawns().addSpawn(MobCategory.CREATURE,
                    new MobSpawnSettings.SpawnerData(ModEntityTypes.CROW.get(), HexConfig.CROW_SPAWN_WEIGHT.get(), HexConfig.CROW_SPAWN_MIN_COUNT.get(), HexConfig.CROW_SPAWN_MAX_COUNT.get()));
        }
    }
