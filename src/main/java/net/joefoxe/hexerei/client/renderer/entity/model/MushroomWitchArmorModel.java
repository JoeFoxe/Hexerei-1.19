...
public class MushroomWitchArmorModel<T extends LivingEntity> extends ArmorModel<T> {
    ...
    public static LayerDefinition createBodyLayer() {
		...
		PartDefinition LeftBoot = root.getChild("LeftBoot");
		PartDefinition LeftArm = root.getChild("LeftArm");
		PartDefinition RightArm = root.getChild("RightArm");
		PartDefinition Head = root.getChild("Head");

		PartDefinition Hat = Head.addOrReplaceChild("Hat", CubeListBuilder.create(), PartPose.offset(3.9181F, 24.0542F, -9.2644F));

		PartDefinition head_r12_r1 = Hat.addOrReplaceChild("head_r12_r1", CubeListBuilder.create().texOffs(20, 54).addBox(-3.0F, -2.0F, -3.5F, 6.0F, 4.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-2.9323F, -34.1829F, 11.26F, -0.4111F, 0.298F, 0.742F));

		PartDefinition head_r11_r1 = Hat.addOrReplaceChild("head_r11_r1", CubeListBuilder.create().texOffs(64, 19).addBox(-1.75F, -2.75F, -2.75F, 4.0F, 4.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-1.9504F, -35.302F, 11.9669F, -0.5659F, 0.6012F, 1.0441F));

		PartDefinition head_r10_r1 = Hat.addOrReplaceChild("head_r10_r1", CubeListBuilder.create().texOffs(32, 15).addBox(-4.0F, -2.0F, -4.0F, 8.0F, 4.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-3.6757F, -32.4244F, 10.1967F, -0.435F, 0.1227F, 0.3078F));

		PartDefinition head_r9_r1 = Hat.addOrReplaceChild("head_r9_r1", CubeListBuilder.create().texOffs(0, 23).addBox(-4.4901F, -34.6229F, -3.5319F, 9.0F, 3.0F, 9.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-7.0424F, -0.4419F, -2.5444F, -0.3481F, 0.0316F, 0.0844F));

		PartDefinition head_r8_r1 = Hat.addOrReplaceChild("head_r8_r1", CubeListBuilder.create().texOffs(30, 12).addBox(-2.4242F, -0.989F, 1.265F, 2.0F, 2.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-9.4013F, -29.1325F, 7.6866F, -0.353F, 0.5198F, -0.3144F));

		PartDefinition head_r7_r1 = Hat.addOrReplaceChild("head_r7_r1", CubeListBuilder.create().texOffs(30, 17).addBox(3.7904F, -0.9892F, 2.3201F, 2.0F, 2.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-9.4013F, -29.1325F, 7.6866F, -0.4441F, -0.7977F, 0.1948F));

		PartDefinition head_r6_r1 = Hat.addOrReplaceChild("head_r6_r1", CubeListBuilder.create().texOffs(34, 6).addBox(0.4283F, -34.4329F, -5.8296F, 3.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(5.1286F, 1.4376F, -1.2699F, -0.4114F, 0.7224F, -0.4143F));

		PartDefinition head_r5_r1 = Hat.addOrReplaceChild("head_r5_r1", CubeListBuilder.create().texOffs(47, 43).addBox(-0.5043F, -34.2898F, -5.275F, 3.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-1.7827F, 1.6724F, -2.9758F, -0.3521F, -0.5156F, 0.0458F));

		PartDefinition head_r4_r1 = Hat.addOrReplaceChild("head_r4_r1", CubeListBuilder.create().texOffs(75, 67).addBox(7.1618F, -32.337F, -16.6321F, 4.0F, 2.0F, 2.0F, new CubeDeformation(0.0F))
				...
				.texOffs(0, 0).addBox(-0.8382F, -32.337F, -14.6321F, 12.0F, 2.0F, 10.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-3.7272F, 3.6122F, 8.827F, -0.3048F, -0.0186F, -0.1276F));

		PartDefinition head_r6_r2 = Hat.addOrReplaceChild("head_r6_r2", CubeListBuilder.create().texOffs(67, 55).addBox(-2.4F, -0.998F, -0.425F, 4.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-1.1121F, -28.3283F, 13.7299F, -0.3713F, -0.5971F, 0.0821F));

		PartDefinition head_r8_r2 = Hat.addOrReplaceChild("head_r8_r2", CubeListBuilder.create().texOffs(39, 19).addBox(-0.5F, -0.575F, 0.175F, 1.0F, 1.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-3.0441F, -26.1207F, 14.8562F, 0.0331F, 0.271F, -0.2134F));

		PartDefinition head_r7_r2 = Hat.addOrReplaceChild("head_r7_r2", CubeListBuilder.create().texOffs(56, 19).addBox(-4.125F, -0.996F, -1.15F, 4.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-1.1121F, -28.3283F, 13.7299F, -0.3209F, 0.3138F, -0.2357F));

		PartDefinition head_r7_r3 = Hat.addOrReplaceChild("head_r7_r3", CubeListBuilder.create().texOffs(6, 79).addBox(-1.5F, -1.0F, 0.3F, 3.0F, 2.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-5.857F, -25.1251F, 15.1501F, 0.0006F, -0.0186F, -0.1276F));

		PartDefinition head_r5_r2 = Hat.addOrReplaceChild("head_r5_r2", CubeListBuilder.create().texOffs(39, 19).addBox(-0.5F, -0.5F, 0.175F, 1.0F, 1.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-5.217F, -29.924F, 1.9664F, 0.0006F, -0.0186F, -0.1276F));

		PartDefinition head_r4_r2 = Hat.addOrReplaceChild("head_r4_r2", CubeListBuilder.create().texOffs(68, 7).addBox(-1.3562F, -1.0008F, 6.3931F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F))
				.texOffs(67, 45).addBox(-1.3562F, -1.0008F, -5.6069F, 2.0F, 2.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-9.4013F, -29.1325F, 7.6866F, -0.3048F, -0.0186F, -0.1276F));

		PartDefinition head_r5_r3 = Hat.addOrReplaceChild("head_r5_r3", CubeListBuilder.create().texOffs(0, 0).addBox(-0.025F, -1.25F, -1.75F, 0.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(3.42F, -28.4333F, 8.6506F, -0.1739F, -0.0186F, -0.1276F));

		PartDefinition head_r3_r1 = Hat.addOrReplaceChild("head_r3_r1", CubeListBuilder.create().texOffs(50, 65).addBox(0.5F, -1.0F, 0.1F, 2.0F, 3.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(3.6618F, -35.1716F, 13.8287F, -0.4525F, 1.0241F, 2.2393F));

		PartDefinition head_r4_r3 = Hat.addOrReplaceChild("head_r4_r3", CubeListBuilder.create().texOffs(34, 0).addBox(-1.0F, -3.0F, -0.675F, 1.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(2.1221F, -34.6529F, 12.9012F, 0.1274F, 1.1259F, -3.0809F));

		PartDefinition head_r2_r1 = Hat.addOrReplaceChild("head_r2_r1", CubeListBuilder.create().texOffs(74, 27).addBox(-1.25F, -0.75F, -1.25F, 3.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.5668F, -35.9526F, 12.8484F, -0.6773F, 0.749F, 1.4749F));

		PartDefinition head_r1_r1 = Hat.addOrReplaceChild("head_r1_r1", CubeListBuilder.create().texOffs(0, 12).addBox(-4.825F, -32.95F, -5.25F, 10.0F, 1.0F, 10.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, -0.3048F, -0.0186F, -0.1276F));
